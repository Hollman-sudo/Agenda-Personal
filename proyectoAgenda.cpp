...
void pantallaBienvenida(){   // Esta funci�n  es la pantalla de bienvenida aca va el Art ASCII y pues la bienvenida 
    system("cls"); // Limpiar la pantalla
    system("color 03");  
...
// Funci�n para mostrar el menu de opciones al usuario
void menu() {
	int opcion;
	system("cls");
	system("color 03");
